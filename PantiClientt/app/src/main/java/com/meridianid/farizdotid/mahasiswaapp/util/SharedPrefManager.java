...
public class SharedPrefManager {
    ...
    public static final String SP_PENGHUNI = "spPenghuni";
    public static final String SP_DESKRIPSI = "spDeskripsi";
    ...
    public String getSpPenghuni(){
        return sp.getString(SP_PENGHUNI, "");
    }
    public String getSpDeskripsi(){
        return sp.getString(SP_DESKRIPSI, "");
    }
